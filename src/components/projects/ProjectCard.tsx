...
const buttonClass =
  "flex items-center border-2 font-medium bg-white dark:bg-black dark:text-white px-3 py-2 rounded-lg text-black gap-2 active:scale-[1.1] transition-transform duration-300";

const tagClass =
  "flex items-center gap-x-2 rounded-full w-auto text-xs font-semibold bg-neutral-800 text-white py-2 px-4";
...
const NextJsIcon = () => (
  ...
  >
    <defs>
      <linearGradient id="nextjs_c" x1="55.633%" x2="83.228%" y1="56.385%" y2="96.08%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
      </linearGradient>
      <linearGradient id="nextjs_d" x1="50%" x2="49.953%" y1="0%" y2="73.438%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
      </linearGradient>
      <circle id="nextjs_a" cx="128" cy="128" r="128" />
    </defs>
    <mask id="nextjs_b" fill="#fff">
      <use xlinkHref="#nextjs_a" />
    </mask>
    <g mask="url(#nextjs_b)">
      ...
      />
      <path fill="url(#nextjs_d)" d="M163.556 76.8h17.067v102.4h-17.067z" />
    </g>
  </svg>
);
...
const CssIcon = () => (
  <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520" aria-hidden="true">
...
const JavaScriptIcon = () => (
  <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1052 1052" aria-hidden="true">
...
const tagIcons: Record<string, React.ReactNode> = {
  ...
  "Style Components": <StyleComponentsIcon />,
};
